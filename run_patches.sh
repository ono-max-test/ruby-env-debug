...
# %patch16 -p1
cat ruby-2.5.1-Avoid-need-of-C++-compiler-to-pass-the-test-suite.patch | patch -p1
...
# %patch23 -p1
cat ruby-2.6.0-use-larger-keys-for-SSL-tests.patch | patch -p1

# %patch24 -p1
cat ruby-2.6.0-configure-fstack-protector-strong.patch | patch -p1
